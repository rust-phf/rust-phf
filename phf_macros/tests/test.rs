...
mod map {
    ...
    #[allow(dead_code)]
    phf_map! {
        static TRAILING_COMMA: phf::Map<&'static str, isize> = {
            "foo" => 10,
        };
    }
    ...
    #[allow(dead_code)]
    phf_map! {
        static NO_TRAILING_COMMA: phf::Map<&'static str, isize> = {
            "foo" => 10
        };
    }
    ...
    #[allow(dead_code)]
    phf_map! {
        static BYTE_STRING_KEY: phf::Map<&'static [u8], &'static str> = {
    ...
    fn test_two() {
        item! { phf_map! {
            static MAP: phf::Map<&'static str, isize> = {
                "foo" => 10,
                "bar" => 11,
            };
        }}
    ...
    fn test_array_vals() {
        item! { phf_map! {
            static MAP: phf::Map<&'static str, [u8; 3]> = {
                "a" => [0u8, 1, 2],
            };
        }}
    ...
    fn test_unicase() {
        use unicase::UniCase;
        item! { phf_map! {
            static MAP: phf::Map<UniCase<&'static str>, isize> = {
                UniCase("FOO") => 10,
                UniCase("Bar") => 11,
            };
        }}
    ...
    fn test_unicase_alt() {
        use unicase;
        item! { phf_map! {
            static MAP: phf::Map<unicase::UniCase<&'static str>, isize> = {
...
mod set {
    ...
    #[allow(dead_code)]
    phf_set! {
        static TRAILING_COMMA: phf::Set<&'static str> = {
            "foo",
        };
    }
    ...
    #[allow(dead_code)]
    phf_set! {
        static NO_TRAILING_COMMA: phf::Set<&'static str> = {
            "foo"
        };
    }
...
mod ordered_map {
    ...
    #[allow(dead_code)]
    phf_ordered_map! {
        static TRAILING_COMMA: phf::OrderedMap<&'static str, isize> = {
            "foo" => 10,
        };
    }
    ...
    #[allow(dead_code)]
    phf_ordered_map! {
        static NO_TRAILING_COMMA: phf::OrderedMap<&'static str, isize> = {
            "foo" => 10
        };
    }
    ...
    #[test]
    fn test_two() {
        item! { phf_ordered_map! {
            static MAP: phf::OrderedMap<&'static str, isize> = {
                "foo" => 10,
                "bar" => 11,
            };
        }}
    ...
    fn test_entries() {
        item! { phf_ordered_map! {
            static MAP: phf::OrderedMap<&'static str, i32> = {
                "foo" => 10,
                "bar" => 11,
                "baz" => 12,
            };
...
mod ordered_set {
    ...
    #[allow(dead_code)]
    phf_ordered_set! {
        static TRAILING_COMMA: phf::OrderedSet<&'static str> = {
            "foo",
        };
    }
    ...
    #[allow(dead_code)]
    phf_ordered_set! {
        static NO_TRAILING_COMMA: phf::OrderedSet<&'static str> = {
            "foo"
        };
    }
    ...
    #[test]
    fn test_two() {
        item! { phf_ordered_set! {
            static SET: phf::OrderedSet<&'static str> = {
                "hello",
                "there",
                "world",
            };
    ...
    fn test_index() {
        item! { phf_ordered_set! {
            static MAP: phf::OrderedSet<&'static str> = {
                "foo",
                "bar",
            };
        }}
